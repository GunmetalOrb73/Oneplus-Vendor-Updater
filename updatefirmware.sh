read -p "Please make sure adb is enabled and note there will be one more prompt later on before we continue to flash your device. Press any key to continue..."
mkdir workspace
chmod 777 workspace/
...
read -p "Please authorize your device in the next step then continue"
./platform-tools/adb devices
read -p "Now that your device is authorized please copy firmware to ./workspace/ and rename to firmware.zip then press any key to continue..."
mkdir firmware
